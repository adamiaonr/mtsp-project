...
\begin{figure}[h!]
    \centering
    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/LRU/25/6-2.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-topologies-cascade}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/LRU/25/6-2.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
...
\begin{figure}[h!]
    \centering
    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/LRU/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-cache-alg-cascade-lru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/MRU/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-cache-alg-cascade-mru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/RANDOM/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
...
\begin{figure}[h!]
    \centering
    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/LRU/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-cache-alg-lru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/MRU/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-cache-alg-mru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/RANDOM/25/6-3.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
...
\begin{figure}[h!]
    \centering
    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/LRU/25/6-5.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-latency-cascade-lru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/cascade/RANDOM/25/6-5.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
...
\begin{figure}[h!]
    \centering
    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/LRU/25/6-5.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
        \label{fig:exp-results-latency-tree-lru}
    }

    \subfigure[]{
        \includegraphics[width=0.45\textwidth] {figures/experiments/tree/RANDOM/25/6-5.png}
        %\includegraphics[width=0.30\textwidth] {figures/fib-topo.png}
